...
# Added this because setting the variables in the OS simply does not work no matter what
# This was done in order to use the GPU to train the model
os.environ['TF_ENABLE_MIXED_PRECISION_GRAPH_REWRITE'] = '1'
cuda_bin = r"C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v11.0\bin"
cudnn_bin = r"C:\tools\cuda\bin"

os.environ["CUDA_BIN"] = cuda_bin
os.environ["CUDNN_BIN"] = cudnn_bin
