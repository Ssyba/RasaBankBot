...
if pil_image is not None:
    ...
    _PIL_INTERPOLATION_METHODS = {
        Resampling.NEAREST: pil_image.NEAREST,
        Resampling.BILINEAR: pil_image.BILINEAR,
        Resampling.BICUBIC: pil_image.BICUBIC,
    }
    if hasattr(pil_image, 'HAMMING'):
        _PIL_INTERPOLATION_METHODS[Resampling.HAMMING] = pil_image.HAMMING
    if hasattr(pil_image, 'BOX'):
        _PIL_INTERPOLATION_METHODS[Resampling.BOX] = pil_image.BOX
    if hasattr(pil_image, 'LANCZOS'):
        _PIL_INTERPOLATION_METHODS[Resampling.LANCZOS] = pil_image.LANCZOS
